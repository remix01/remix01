  ...
  public: {
    Tables: {
      ...
      escrow_audit_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "escrow_audit_log_hold_id_fkey"
            columns: ["hold_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "escrow_audit_log_performed_by_fkey"
          ...
          },
          {
            ...
            columns: ["transaction_id"]
            isOneToOne: false
            referencedRelation: "narocnik_placila"
            referencedColumns: ["id"]
          },
        ]
      }
      escrow_disputes: {
        ...
        Relationships: [
          {
            foreignKeyName: "escrow_disputes_hold_id_fkey"
            columns: ["hold_id"]
            isOneToOne: true
            referencedRelation: "escrow_holds"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "escrow_disputes_opened_by_fkey"
            columns: ["opened_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      lead_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "lead_assignments_obrtnik_id_fkey"
            columns: ["obrtnik_id"]
            isOneToOne: false
            referencedRelation: "obrtnik_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "lead_assignments_povprasevanje_id_fkey"
            columns: ["povprasevanje_id"]
            isOneToOne: false
            referencedRelation: "povprasevanja"
            referencedColumns: ["id"]
      ...
      obrtnik_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "obrtnik_profiles_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "categories"
            referencedColumns: ["id"]
      ...
      sandbox_abuse_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "sandbox_abuse_events_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
      ...
      verifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "verifications_obrtnik_id_fkey"
            columns: ["obrtnik_id"]
            isOneToOne: false
            referencedRelation: "obrtnik_profiles"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      narocnik_placila: {
        Row: {
          ...
          currency: string | null
          held_at: string | null
          hold_payment_intent_id: string | null
          hold_status: string | null
          id: string | null
          ima_aktiven_spor: boolean | null
          narocnik_id: string | null
          obrtnik_naziv: string | null
          povprasevanje_naziv: string | null
          processed_at: string | null
          released_at: string | null
          status: string | null
          stripe_payment_intent_id: string | null
    ...
    Functions: {
      ...
      check_ai_quota: { Args: { check_user_id?: string }; Returns: boolean }
      check_expired_povprasevanja: { Args: never; Returns: undefined }
      claim_task: {
        Args: { p_task_id: string; p_worker_id: string }
        Returns: boolean
      }
      ...
      escrow_auto_release: { Args: never; Returns: number }
      expire_lead_assignment: {
        Args: { p_assignment_id: string }
        Returns: {
          next_obrtnik_id: string
          next_rank: number
        }[]
      }
      ...
      increment_active_leads: {
        Args: { p_obrtnik_id: string }
        Returns: undefined
      }
      is_admin: { Args: never; Returns: boolean }
      is_narocnik: { Args: { check_user_id?: string }; Returns: boolean }
      is_obrtnik: { Args: { check_user_id?: string }; Returns: boolean }
      ...
      mark_lead_responded: {
        Args: { p_obrtnik_id: string; p_povprasevanje_id: string }
        Returns: undefined
      }
      match_obrtniki: {
        Args: {
      ...
      reset_daily_ai_quota: { Args: never; Returns: undefined }
      start_task: {
        Args: { p_task_id: string; p_worker_id: string }
        Returns: boolean
      }
