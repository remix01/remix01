...
const allCraftsmen = [
  { id: 1, name: "Marko Kovačič", company: "Kovačič Vodovod s.p.", category: "Vodovod & ogrevanje", location: "Ljubljana", rating: 4.9, reviews: 87, price: "od 35 EUR/h", available: true, badge: "Top mojster", specialties: ["Centralno ogrevanje", "Talno ogrevanje", "Toplotne črpalke"], description: "Izkušen vodoinstalater z več kot 15 leti izkušenj. Specializiran za centralno in talno ogrevanje.", gallery: 12 },
  { id: 2, name: "Aleš Župančič", company: "ElektroFix d.o.o.", category: "Elektrika & pametni sistemi", location: "Maribor", rating: 4.8, reviews: 63, price: "od 40 EUR/h", available: true, badge: "Hiter odziv", specialties: ["Pametni dom", "Elektroinstalacije", "Video nadzor"], description: "Certificiran električar za pametne sisteme in klasične instalacije.", gallery: 8 },
  { id: 3, name: "Tomaž Krajnc", company: "GradPro d.o.o.", category: "Gradnja & adaptacije", location: "Celje", rating: 4.7, reviews: 112, price: "od 30 EUR/h", available: false, badge: null, specialties: ["Adaptacije", "Betonska dela", "Fasade"], description: "Gradbeno podjetje z referencami po vsej Sloveniji.", gallery: 24 },
  { id: 4, name: "Boštjan Rozman", company: "MizarRoz s.p.", category: "Mizarstvo & kovinarstvo", location: "Kranj", rating: 5.0, reviews: 41, price: "od 45 EUR/h", available: true, badge: "Top mojster", specialties: ["Kuhinje po meri", "Vgradne omare", "Stopnice"], description: "Mizar z lastno delavnico. Vse po meri, od kuhinje do stopnic.", gallery: 18 },
  { id: 5, name: "Nina Vidmar", company: "BarvaPlus d.o.o.", category: "Zaključna dela", location: "Ljubljana", rating: 4.6, reviews: 55, price: "od 25 EUR/h", available: true, badge: null, specialties: ["Beljenje", "Tapete", "Dekorativne tehnike"], description: "Natančna in zanesljiva ekipa za vsa zaključna dela.", gallery: 9 },
  { id: 6, name: "Gašper Hribar", company: "OknaFix s.p.", category: "Okna, vrata & senčila", location: "Koper", rating: 4.9, reviews: 29, price: "od 38 EUR/h", available: true, badge: "Hiter odziv", specialties: ["Montaža oken", "Rolete", "Komarniki"], description: "Specialist za okna in senčila z garancijo na delo.", gallery: 6 },
  { id: 7, name: "Rok Potočnik", company: "VrtArt s.p.", category: "Okolica & zunanja ureditev", location: "Novo mesto", rating: 4.5, reviews: 34, price: "od 28 EUR/h", available: true, badge: null, specialties: ["Urejanje okolice", "Tlakovanje", "Namakanje"], description: "Kreativne rešitve za vaš vrt in okolico.", gallery: 15 },
  { id: 8, name: "Peter Oblak", company: "ServisNaDom d.o.o.", category: "Vzdrževanje & popravila", location: "Ljubljana", rating: 4.8, reviews: 72, price: "od 32 EUR/h", available: true, badge: "Top mojster", specialties: ["Hišništvo", "Montaža", "Popravila"], description: "Zanesljiv servis za manjša popravila in vzdrževanje.", gallery: 5 },
  { id: 9, name: "Jure Horvat", company: "AquaServis d.o.o.", category: "Vodovod & ogrevanje", location: "Maribor", rating: 4.6, reviews: 43, price: "od 33 EUR/h", available: true, badge: null, specialties: ["Vodoinstalacije", "Bojlerji", "Plinski sistemi"], description: "Hiter in zanesljiv vodovodni servis za dom in podjetje.", gallery: 7 },
  { id: 10, name: "Matej Novak", company: "ElektroPro s.p.", category: "Elektrika & pametni sistemi", location: "Ljubljana", rating: 4.9, reviews: 91, price: "od 42 EUR/h", available: true, badge: "Top mojster", specialties: ["Alarmni sistemi", "Polnilnice EV", "Razsvetljava"], description: "Premium električni servis z najvišjo oceno v Ljubljani.", gallery: 14 },
  { id: 11, name: "Simon Žagar", company: "ŽagarGrad d.o.o.", category: "Gradnja & adaptacije", location: "Ljubljana", rating: 4.8, reviews: 67, price: "od 35 EUR/h", available: true, badge: "Hiter odziv", specialties: ["Prenove kopalnic", "Suhomontaža", "Keramika"], description: "Specializirani za kompletne prenove kopalnic in stanovanj.", gallery: 21 },
  { id: 12, name: "Luka Kos", company: "KosMizar s.p.", category: "Mizarstvo & kovinarstvo", location: "Celje", rating: 4.7, reviews: 38, price: "od 40 EUR/h", available: false, badge: null, specialties: ["Kovinske konstrukcije", "Ograje", "Nadstreški"], description: "Kovinarstvo in mizarstvo z lastno proizvodnjo.", gallery: 10 },
]
