...
import { Home, Search, FileText, Star, User, LogOut } from 'lucide-react'
...
export default async function ObrtnikLayout({
  children,
}: {
        ...
        <div className="absolute bottom-0 w-64 border-t bg-card p-4">
          <div className="mb-3 text-sm">
            <p className="font-medium text-foreground">
              {obrtnikProfile?.business_name || profile.full_name}
            </p>
            <p className="text-xs text-muted-foreground">Obrtnik</p>
          </div>
          <form action={logout}>
