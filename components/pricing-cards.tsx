...
const plans = [
  {
    ...
    features: [
      ...
      "AI: Opis dela, Primerjava ponudb, Urnik",
    ],
    hook: "Plačaš samo, ko zaslužiš. Brez tveganja. AI asistent vključen.",
  },
  {
    name: "PRO",
    badge: "Priporočeno",
    ...
    features: [
      ...
      { text: "AI: Generator ponudb", proBadge: true },
      { text: "AI: Materiali in zaloge", proBadge: true },
      { text: "AI: Video diagnoza problema", proBadge: true },
      { text: "AI: Povzetek dela", proBadge: true },
