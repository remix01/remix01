...
const navItems: NavItem[] = [
  ...
  { icon: CreditCard, label: 'Finance', href: '/admin/finance', roles: ['SUPER_ADMIN', 'MODERATOR'] },
  { icon: Briefcase, label: 'Kategorije', href: '/admin/categories', roles: ['SUPER_ADMIN', 'MODERATOR'] },
  { icon: Database, label: 'Data Quality', href: '/admin/data-quality', roles: ['SUPER_ADMIN', 'MODERATOR'] },
