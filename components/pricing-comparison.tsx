...
const features = [
  ...
  { name: "AI sporočila/dan", start: "5", pro: "100" },
  { name: "AI: Generator ponudb", start: false, pro: true },
  { name: "AI: Materiali in zaloge", start: false, pro: true },
  { name: "AI: Video diagnoza", start: false, pro: true },
  { name: "AI: Povzetek dela", start: false, pro: true },
  { name: "Urnik in termini", start: true, pro: true },
