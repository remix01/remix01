...
export function PartnerSidebar({ partner }: PartnerSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-x-0 bottom-0 top-auto z-40 h-[85dvh] w-full transform-gpu rounded-t-2xl border-t bg-background shadow-xl transition-transform duration-300 lg:inset-y-0 lg:inset-x-auto lg:left-auto lg:right-0 lg:h-full lg:max-w-sm lg:rounded-none lg:border-l lg:border-t-0 ${
          isAiSidebarOpen
