...
export function buildOAuthCallbackUrl(params?: { provider?: string | null; role?: 'narocnik' | 'obrtnik' | null; next?: string | null }): string {
  ...
  return getOAuthRedirectTo(callbackPath)
}
