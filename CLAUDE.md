...
Vercel:      prj_G4r2tTNM2sZpWmOTKw82tWQZ0FpK / team_9MdWpYGqWEMLZcI0vcdQ8Mz4
...
1. **Security** — RLS + RBAC + SECURITY DEFINER
1. **Realtime** — Supabase channels
1. **AI** — 7 agents, tier-gated (START: 10/day, PRO: 100/day)
1. **Stripe** — Subscriptions + webhooks
1. **Async** — XState + QStash
1. **Observability** — Structured logging
1. **DevOps** — GitHub → Vercel auto-deploy
...
1. NEVER duplicate components
1. ALWAYS use exact paths: `app/(narocnik)/dashboard/page.tsx`
1. Table is `obrtnik_profiles` NOT `obrtniki`
